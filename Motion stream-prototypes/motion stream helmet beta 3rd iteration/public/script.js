...
//Group added conditional to change colors according to value, also prints direction
  ...
  } else if (event.rot.beta > 20 && event.rot.beta < 60) {
...
function showData(m) {
  ...
  html += 'rot';
  html += '<table align="center"><tr><td>' + m.rot.beta.toFixed(3) + '</td><td>' + m.rot.beta.toFixed(3) + '</td><td>' + m.rot.beta.toFixed(3) + '</tr></table>';
  
  html += 'rotMotion';
  html += '<table align="center"><tr><td>' + m.rotMotion.beta.toFixed(3) + '</td><td>' + m.rotMotion.beta.toFixed(3) + '</td><td>' + m.rotMotion.beta.toFixed(3) + '</tr></table>';
