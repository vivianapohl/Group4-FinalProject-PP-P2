...
//Group added conditional to change colors according to value, also prints direction
  ...
  } else if (event.rot.gamma > 30 && event.rot.gamma < 80) {
...
function showData(m) {
  ...
  html += 'rot';
  html += '<table align="center"><tr><td>' + m.rot.gamma.toFixed(3) + '</td><td>' + m.rot.gamma.toFixed(3) + '</td><td>' + m.rot.gamma.toFixed(3) + '</tr></table>';
  
  html += 'rotMotion';
  html += '<table align="center"><tr><td>' + m.rotMotion.gamma.toFixed(3) + '</td><td>' + m.rotMotion.gamma.toFixed(3) + '</td><td>' + m.rotMotion.gamma.toFixed(3) + '</tr></table>';
